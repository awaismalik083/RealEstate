...
const Footer = () => {
    return (
        <footer className="bg-[#111] text-white pt-10 pb-5 px-6 md:px-20">
            ...
            {/* Bottom bar */}
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 mt-10 border-t border-gray-700 pt-5">
                <div className="flex items-center mb-3 md:mb-0">
                    <img src={asset.logo} alt="logo" className="w-6 h-6" />
                    <img className="w-20" src={asset.logo7} alt="" />
                </div>
                <div className="flex items-center gap-9 mr-80 justify-center">
                    <a href="#">Home</a>
                    <a href="#">Property</a>
                    <a href="#">Page</a>
                    <a href="#">Blog</a>
                ...
                <div className="flex justify-center gap-6">
                    <a><img className="cursor-pointer" src={asset.fb} alt="Facebook" /></a>
                    <a><img className="cursor-pointer" src={asset.link} alt="LinkedIn" /></a>
                    <a><img className="cursor-pointer" src={asset.insta} alt="Instagram" /></a>
                    <a><img className="cursor-pointer" src={asset.twt} alt="Twitter" /></a>
                </div>
            </div>
        </footer>
    );
